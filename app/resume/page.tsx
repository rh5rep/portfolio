    ...
    <main>
      ...
      <section className="resume-page site-shell">
        <div className="resume-page__heading">
          ...
          <div className="resume-page__actions"><Link className="button button--dark" href="/resume.pdf" download="Rami_Hanna_Robotics_Systems_Resume.pdf">Download CV</Link><Link className="button button--quiet" href="mailto:s242507@dtu.dk">Email</Link></div>
        </div>
