    ...
    <main>
      ...
      <section className="resume-page site-shell">
        <div className="resume-page__heading">
          ...
          <div className="resume-page__actions"><Link className="button button--dark" href="/resume.pdf" download="Rami_Hanna_Resume.pdf">Download PDF</Link><Link className="button button--quiet" href="mailto:s242507@dtu.dk">Email</Link></div>
        </div>
