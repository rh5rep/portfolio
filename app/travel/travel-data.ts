...
export const travelLocations: TravelLocation[] = [
  ...
  { name: "Copenhagen", coords: [55.6761, 12.5683], region: "Europe" },
  { name: "Malmö", coords: [55.605, 13.0038], region: "Europe" },
  { name: "Stockholm", coords: [59.3293, 18.0686], region: "Europe" },
  { name: "Kraków", coords: [50.0647, 19.945], region: "Europe" },
  ...
  { name: "Batroun", coords: [34.2553, 35.6588], region: "Middle East" },
  { name: "Jounieh", coords: [33.9808, 35.6178], region: "Middle East" },
  { name: "Ehden", coords: [34.3031, 35.9389], region: "Middle East" },
  { name: "Beijing", coords: [39.9042, 116.4074], region: "East Asia" },
  { name: "Hanoi", coords: [21.0285, 105.8542], region: "Southeast Asia" },
  { name: "Ha Long Bay", coords: [20.9101, 107.1839], region: "Southeast Asia" },
  { name: "Ha Giang", coords: [22.8136, 104.9836], region: "Southeast Asia" },
  { name: "Ninh Binh", coords: [20.2528, 105.975], region: "Southeast Asia" },
  { name: "Phong Nha", coords: [17.5904, 106.2838], region: "Southeast Asia" },
  { name: "Hoi An", coords: [15.8801, 108.338], region: "Southeast Asia" },
  { name: "Bangkok", coords: [13.7563, 100.5018], region: "Southeast Asia" },
  { name: "Chiang Mai", coords: [18.7061, 98.9817], region: "Southeast Asia" },
  { name: "Pai", coords: [19.3592, 98.4396], region: "Southeast Asia" },
  { name: "Krabi", coords: [8.0863, 98.9063], region: "Southeast Asia" },
  { name: "Koh Phi Phi", coords: [7.7407, 98.7784], region: "Southeast Asia" },
  { name: "Koh Tao", coords: [10.09808, 99.83809], region: "Southeast Asia" },
  { name: "Koh Phangan", coords: [9.7317, 100.0136], region: "Southeast Asia" },
  ...
  { name: "Rotorua", coords: [-38.1368, 176.2497], region: "Oceania" },
  { name: "Wellington", coords: [-41.2866, 174.7756], region: "Oceania" },
  { name: "Queenstown", coords: [-45.0312, 168.6626], region: "Oceania" },
  { name: "Christchurch", coords: [-43.5321, 172.6362], region: "Oceania" },
  { name: "Lake Tekapo", coords: [-44.0047, 170.478], region: "Oceania" },
  { name: "Aoraki / Mount Cook", coords: [-43.595, 170.141], region: "Oceania" },
  { name: "Wānaka", coords: [-44.698, 169.132], region: "Oceania" },
  { name: "Milford Sound", coords: [-44.671, 167.925], region: "Oceania" },
  { name: "Hobart", coords: [-42.8821, 147.3272], region: "Oceania" },
  { name: "Freycinet National Park", coords: [-42.119, 148.286], region: "Oceania" },
  { name: "Cradle Mountain", coords: [-41.654, 145.954], region: "Oceania" },
];
