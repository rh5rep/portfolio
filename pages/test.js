...
import { Box, VStack, HStack, Spacer, Text, Center, Heading, Divider, Link, useColorMode } from '@chakra-ui/react';
...
export default function Capstone({ Component, pageProps }) {
  ...
  // Safeguard against undefined media item
  ...
  return (
    <VStack>
      ...
      <Center className={styles.carouselContainer}>
        <Box>
          <HStack>
            <FaArrowLeft className={styles.carouselArrow} onClick={handlePrevMedia} />
            <Spacer />
            ...
            <Spacer />
            <FaArrowRight className={styles.carouselArrow} onClick={handleNextMedia} />
          </HStack>
          <Center>
            <VStack>
